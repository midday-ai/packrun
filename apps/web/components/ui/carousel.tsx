...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ref={ref}
      className={cn(
        "absolute h-8 w-8 border border-border bg-background text-foreground hover:bg-surface disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center transition-colors",
